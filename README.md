# teazy-peazy-advent-of-code-bt

[![Build Status](https://github.com/ONS-Innovation/teazy-peazy-advent-of-code-bt/actions/workflows/ci.yml/badge.svg)](https://github.com/ONS-Innovation/teazy-peazy-advent-of-code-bt/actions/workflows/ci.yml)
[![Build Status](https://github.com/ONS-Innovation/teazy-peazy-advent-of-code-bt/actions/workflows/security-scan.yml/badge.svg)](https://github.com/ONS-Innovation/teazy-peazy-advent-of-code-bt/actions/workflows/security-scan.yml)
[![Build Status](https://github.com/ONS-Innovation/teazy-peazy-advent-of-code-bt/actions/workflows/codeql.yml/badge.svg)](https://github.com/ONS-Innovation/teazy-peazy-advent-of-code-bt/actions/workflows/codeql.yml)
[![Linting: Ruff](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/charliermarsh/ruff/main/assets/badge/v2.json)](https://github.com/astral-sh/ruff)
[![poetry-managed](https://img.shields.io/badge/poetry-managed-blue)](https://python-poetry.org/)
[![License - MIT](https://img.shields.io/badge/licence%20-MIT-1ac403.svg)](https://github.com/ONS-Innovation/teazy-peazy-advent-of-code-bt/blob/main/LICENSE)
...
```bash
git clone https://github.com/ONS-Innovation/teazy-peazy-advent-of-code-bt.git
```
...
```bash
# Extract data
poetry run python -c "from teazy_peazy_advent_of_code_bt.extract import extract_from_source; print(extract_from_source('example_data.csv'))"
...
```python
from teazy_peazy_advent_of_code_bt import ETLPipeline
...
```bash
poetry run mypy teazy_peazy_advent_of_code_bt
```

### GitHub actions

Linting/formatting and Security Scanning GitHub actions are enabled by default on template repositories. If you go to the `Actions` tab on your [repository](https://github.com/ONS-Innovation/teazy-peazy-advent-of-code-bt/actions), you can view all the workflows for the repository. If an action has failed, it will show a red circle with a cross in it.
